...
//     return(<div className='min-h-screen'>hello
//          {result.map((item)=>(
//           <div>{item.image}</div>
//          ))}
//     </div>)
    ...
    <div>
{
  ...
  result.map((item)=>(
    <div>  <div className='grid  grid-cols-[auto,1fr,1fr] gap-0 ml-0 mt-10'><div className='mr-4'><Image
    src={item.image}
    alt='hello'
 width={100}
  height={100}
   
    /></div><div className='w-full h-full mr-4 mb-36'>
    <Image
     src={item.image}
      alt='hello'
    width={1000}
    height={1000}
     ...
     />  
   </div><div className=' w-96 ml-16 mt-24 mb-10'>
    ...
    <p className='flex justify-between items-end mt-5'>
     ...
     <h2 className='font-bold text-3xl font-sans pl-3'>${item.price}</h2></p>
    </div>
</div>
